  ...
  return (
    <>
      <Table className="rounded-xl border border-richblack-800 w-full">
        <Thead>
          <Tr className="rounded-t-md border-b border-b-richblack-800">
          ...
          {courses?.length === 0 ? (
            ...
            courses?.map((course) => (
              <Tr key={course._id} className="border-b border-richblack-800">
                  ...
                  <div className="flex gap-x-4">
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      {course.status === COURSE_STATUS.DRAFT ? (
                        <div className="flex w-fit items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-pink-100">
                          <HiClock size={14} />
                          Drafted
                        </div>
                      ) : (
                ...
                <Td className="text-sm font-medium text-richblack-100 px-6 py-8">
