  ...
  return (
    <>
      <div className={`relative w-full bg-richblack-800`}>
        {/* Hero Section */}
        <div className="mx-auto box-content px-4 lg:w-max-content 2xl:relative ">
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-max-content">
